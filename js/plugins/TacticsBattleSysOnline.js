...
/*:
 * @plugindesc DISSIDIA TACTICS FANTASY専用のオンライン対戦用プラグイン
 *
 * @author サボテンマン (ベースは「くらむぼん」様)
 *
 * @param apiKey
...
(function () {
    ...
    OnlineManager.awake = function () {
        ...
        try {
            ...
            firebase.initializeApp({ apiKey: "AIzaSyBWuNpQ98b4rw7wdNUltjkC41QukMw2dUo", authDomain: "dissidia-tactics-fantasy.firebaseapp.com", databaseURL: "https://dissidia-tactics-fantasy-default-rtdb.firebaseio.com" });
        } catch (e) {
